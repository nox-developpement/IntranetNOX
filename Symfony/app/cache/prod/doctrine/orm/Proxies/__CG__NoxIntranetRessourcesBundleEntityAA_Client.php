 ...
 */
class AA_Client extends \NoxIntranet\RessourcesBundle\Entity\AA_Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NoxIntranet\\RessourcesBundle\\Entity\\AA_Client' . "\0" . 'id', '' . "\0" . 'NoxIntranet\\RessourcesBundle\\Entity\\AA_Client' . "\0" . 'nClient', '' . "\0" . 'NoxIntranet\\RessourcesBundle\\Entity\\AA_Client' . "\0" . 'nomClient'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AA_Client $proxy) {
