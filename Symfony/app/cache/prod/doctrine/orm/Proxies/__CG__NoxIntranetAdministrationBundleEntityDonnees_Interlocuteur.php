 ...
 */
class Donnees_Interlocuteur extends \NoxIntranet\AdministrationBundle\Entity\Donnees_Interlocuteur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Donnees_Interlocuteur $proxy) {
