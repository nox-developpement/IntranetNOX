 ...
 */
class Imprimantes extends \NoxIntranet\RessourcesBundle\Entity\Imprimantes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Imprimantes $proxy) {
