 ...
 */
class AffairesGX extends \NoxIntranet\PointageBundle\Entity\AffairesGX implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NoxIntranet\\PointageBundle\\Entity\\AffairesGX' . "\0" . 'id', '' . "\0" . 'NoxIntranet\\PointageBundle\\Entity\\AffairesGX' . "\0" . 'numero', '' . "\0" . 'NoxIntranet\\PointageBundle\\Entity\\AffairesGX' . "\0" . 'nom', '' . "\0" . 'NoxIntranet\\PointageBundle\\Entity\\AffairesGX' . "\0" . 'identifiant'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AffairesGX $proxy) {
