...
class __TwigTemplate_33dca141fd0f7c1c93a93754c36614c9c0c316cb4821ba429d4c4d62787eccf9 extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 38
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "@Twig/Exception/exception.html.twig", 38)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => (isset($context["previous_count"]) ? $context["previous_count"] : null)));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 64
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "@Twig/Exception/exception.html.twig", 64)->display(array("logs" => $this->getAttribute((isset($context["logger"]) ? $context["logger"] : null), "logs", array())));
            // line 65
            echo "        </div>
    </div>
";
...
";
        // line 89
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "@Twig/Exception/exception.html.twig", 89)->display(array("exception" => (isset($context["exception"]) ? $context["exception"] : null)));
        // line 90
        echo "
