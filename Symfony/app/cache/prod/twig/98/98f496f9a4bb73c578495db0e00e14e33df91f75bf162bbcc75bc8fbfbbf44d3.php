...
class __TwigTemplate_73e5a00a3e6adbe01a1bbfc77866095c4e4c6219cfe78a71bdbe73a399c18797 extends Twig_Template
{
...
";
    ...
    ";
        // line 11
        if (($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()) && $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_COMMUNICATION"))) {
            // line 12
            echo "    <!-- Externe -->
    ...
    <div id='sousMenuInterne' class='menu'>
        ...
        ";
        // line 128
        if (($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()) && $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_CE"))) {
            // line 129
            echo "            <div class=\"sousMessageAcceuil\"> 
        ...
        ";
        // line 134
        if (($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()) && $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_CHSCT"))) {
            // line 135
            echo "            <div class=\"sousMessageAcceuil\"> 
...
";
    ...
    {
        return new Twig_Source("", "NoxIntranetAdministrationBundle:AdministrationCommunication:administrationcommunication.html.twig", "C:\\wamp\\www\\Symfony\\src\\NoxIntranet\\AdministrationBundle/Resources/views/AdministrationCommunication/administrationcommunication.html.twig");
    }
}
