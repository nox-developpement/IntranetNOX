...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['noxintranet_pdfparsing.parsepdf'] = new \NoxIntranet\PDFParsingBundle\ExtractPDFMetadatas\NoxIntranetExtractPDFMetadatas($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'noxintranet_references.putkeywordsnumber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
                    ...
                    'citations' => array(
                        ...
                        'connector' => array(
                            ...
                            'roots' => array(
                                'uploads' => array(
                                    'driver' => 'LocalFileSystem',
                                    'path' => 'uploads/AQ/CERTIFICATSISOETOPQIBI/CITATIONS',
                                    'upload_allow' => array(
                                        0 => 'application/pdf',
                                    ),
                                    'upload_deny' => array(
