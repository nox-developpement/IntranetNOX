...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \NoxIntranet\AdministrationBundle\MajUserDB\NoxIntranetMajUserDB A NoxIntranet\AdministrationBundle\MajUserDB\NoxIntranetMajUserDB instance
     */
    protected function getNoxintranetAdministration_MajuserdbService()
    {
        return $this->services['noxintranet_administration.majuserdb'] = new \NoxIntranet\AdministrationBundle\MajUserDB\NoxIntranetMajUserDB($this->get('doctrine.orm.default_entity_manager'), $this);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('intranet_version', 'v1.7');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57cd5af97824e8.25942645')), true);
