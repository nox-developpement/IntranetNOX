        ...
        if (0 === strpos($pathinfo, '/administrat')) {
            ...
            if (0 === strpos($pathinfo, '/administration')) {
                ...
                if (0 === strpos($pathinfo, '/administration/stats-vpn')) {
                    ...
                    if ($pathinfo === '/administration/stats-vpn/export') {
                        return array (  '_controller' => 'NoxIntranet\\AdministrationBundle\\Controller\\StatsVPN\\StatsVPNController::exportVPNExcelAction',  '_route' => 'nox_intranet_vpn_export',);
                    }
