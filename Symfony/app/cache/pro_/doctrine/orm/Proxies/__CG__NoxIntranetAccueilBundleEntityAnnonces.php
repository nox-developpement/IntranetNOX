 ...
 */
class Annonces extends \NoxIntranet\AccueilBundle\Entity\Annonces implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NoxIntranet\\AccueilBundle\\Entity\\Annonces' . "\0" . 'id', '' . "\0" . 'NoxIntranet\\AccueilBundle\\Entity\\Annonces' . "\0" . 'categorie', '' . "\0" . 'NoxIntranet\\AccueilBundle\\Entity\\Annonces' . "\0" . 'message'];
        }
