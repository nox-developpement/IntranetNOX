 ...
 */
class CompteurDemande extends \NoxIntranet\SupportSIBundle\Entity\CompteurDemande implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompteurDemande $proxy) {
