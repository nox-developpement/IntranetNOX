 ...
 */
class Fichier_Suivi extends \NoxIntranet\AdministrationBundle\Entity\Fichier_Suivi implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NoxIntranet\\AdministrationBundle\\Entity\\Fichier_Suivi' . "\0" . 'id', '' . "\0" . 'NoxIntranet\\AdministrationBundle\\Entity\\Fichier_Suivi' . "\0" . 'chemin', '' . "\0" . 'NoxIntranet\\AdministrationBundle\\Entity\\Fichier_Suivi' . "\0" . 'profil'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Fichier_Suivi $proxy) {
