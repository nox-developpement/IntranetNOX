 ...
 */
class Compteur extends \NoxIntranet\AccueilBundle\Entity\Compteur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NoxIntranet\\AccueilBundle\\Entity\\Compteur' . "\0" . 'id', '' . "\0" . 'NoxIntranet\\AccueilBundle\\Entity\\Compteur' . "\0" . 'compteur', '' . "\0" . 'NoxIntranet\\AccueilBundle\\Entity\\Compteur' . "\0" . 'vue'];
        }
