...
class Archive extends \NoxIntranet\RessourcesBundle\Entity\Archive implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NoxIntranet\\RessourcesBundle\\Entity\\Archive' . "\0" . 'id', '' . "\0" . 'NoxIntranet\\RessourcesBundle\\Entity\\Archive' . "\0" . 'agence', '' . "\0" . 'NoxIntranet\\RessourcesBundle\\Entity\\Archive' . "\0" . 'lien', '' . "\0" . 'NoxIntranet\\RessourcesBundle\\Entity\\Archive' . "\0" . 'chemin'];
        }
