 ...
 */
class texteEncart extends \NoxIntranet\AdministrationBundle\Entity\texteEncart implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (texteEncart $proxy) {
