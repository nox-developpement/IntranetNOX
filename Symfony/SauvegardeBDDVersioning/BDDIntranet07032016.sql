...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19051 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (5445,'Env',1),(5446,'Montagne',1),(5447,'Ecologie',1),(5448,'Méthodologie',1),(5449,'Références',1),(5450,'Ajout',1),(5451,'Suppression',1),(5452,'Documents',1),(5453,'Mots-clés',1);
...
-- Dump completed on 2016-03-07  8:00:05
