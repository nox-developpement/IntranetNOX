...
INSERT INTO `compteur` VALUES (1,'Accueil','1750');
...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24419 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (6309,'Env',1),(6310,'Montagne',1),(6311,'Ecologie',1),(6312,'Méthodologie',1),(6313,'Références',1),(6314,'Ajout',1),(6315,'Suppression',1),(6316,'Documents',1),(6317,'Mots-clés',1);
...
-- Dump completed on 2016-03-11  8:00:05
