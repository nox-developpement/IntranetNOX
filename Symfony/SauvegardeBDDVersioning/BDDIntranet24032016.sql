...
INSERT INTO `compteur` VALUES (1,'Accueil','2563');
...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47655 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `references_keywords` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9117 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (9108,'Env',1),(9109,'Montagne',1),(9110,'Ecologie',1),(9111,'Méthodologie',1),(9112,'Références',1),(9113,'Ajout',1),(9114,'Suppression',1),(9115,'Documents',1),(9116,'Mots-clés',1);
...
-- Dump completed on 2016-03-24  8:00:06
