...
INSERT INTO `compteur` VALUES (1,'Accueil','220');
...
CREATE TABLE `references_keywords` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8892 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (8883,'Env',1),(8884,'Montagne',1),(8885,'Ecologie',1),(8886,'Méthodologie',1),(8887,'Références',1),(8888,'Ajout',1),(8889,'Suppression',1),(8890,'Documents',1),(8891,'Mots-clés',1);
...
-- Dump completed on 2016-03-23  8:00:09
