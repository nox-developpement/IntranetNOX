...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17083 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `references_keywords` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5022 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (5013,'Env',1),(5014,'Montagne',1),(5015,'Ecologie',1),(5016,'Méthodologie',1),(5017,'Références',1),(5018,'Ajout',1),(5019,'Suppression',1),(5020,'Documents',1),(5021,'Mots-clés',1);
...
-- Dump completed on 2016-03-05  8:00:06
