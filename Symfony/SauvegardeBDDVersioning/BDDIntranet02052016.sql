...
--
-- Table structure for table `aa_client`
--

DROP TABLE IF EXISTS `aa_client`;
...
--
-- Dumping data for table `aa_client`
--

LOCK TABLES `aa_client` WRITE;
/*!40000 ALTER TABLE `aa_client` DISABLE KEYS */;
/*!40000 ALTER TABLE `aa_client` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aa_client_adr`
--

DROP TABLE IF EXISTS `aa_client_adr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aa_client_adr` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `N_ClientAdr` int(11) DEFAULT NULL,
  `N_Client` int(11) DEFAULT NULL,
  `Tel` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Fax` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Email` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Nom_Ville` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Nom_Pays` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `aa_client_adr`
--

LOCK TABLES `aa_client_adr` WRITE;
/*!40000 ALTER TABLE `aa_client_adr` DISABLE KEYS */;
/*!40000 ALTER TABLE `aa_client_adr` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aa_contact`
--

DROP TABLE IF EXISTS `aa_contact`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aa_contact` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `N_Contact` int(11) DEFAULT NULL,
  `N_Client` int(11) DEFAULT NULL,
  `Nom_Contact` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Prenom_Contact` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Titre` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Nom_Ville` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Nom_Pays` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Code_Postal` int(11) DEFAULT NULL,
  `Ligne_Directe` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `aa_contact`
--

LOCK TABLES `aa_contact` WRITE;
/*!40000 ALTER TABLE `aa_contact` DISABLE KEYS */;
/*!40000 ALTER TABLE `aa_contact` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `compteur` VALUES (5,'Accueil','871');
...
INSERT INTO `compteur_demande` VALUES (6,2,'2016-03-24');
...
INSERT INTO `donnees_formulaire` VALUES (53,76,'Cargo'),(54,76,'SD'),(55,79,'Test');
...
INSERT INTO `fichier_suivi` VALUES (20,'C:\\wamp\\www\\Symfony\\web\\uploads\\AssistantAffaires\\FeuillesSuivis\\Materiel Informatique','Informatique');
...
INSERT INTO `formulaires` VALUES (76,'Type','Données','Informatique',1),(77,'Objet','Texte','Informatique',0),(78,'Prix unitaire','Nombre','Informatique',0),(79,'BLabl','Données','Informatique',1);
...
INSERT INTO `liaison_suivi_champ` VALUES (41,77,20,'A1');
...
LOCK TABLES `message_alert` WRITE;
/*!40000 ALTER TABLE `message_alert` DISABLE KEYS */;
INSERT INTO `message_alert` VALUES (1,'Accueil','<p>&nbsp;</p>\r\n\r\n<p style=\"text-align:center\"><img alt=\"\" src=\"http://49.media.tumblr.com/tumblr_lrbu1l9BJk1qgzxcao1_250.gif\" style=\"width:80%\" /></p>',0);
/*!40000 ALTER TABLE `message_alert` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=123587 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `profils` VALUES (18,'Informatique'),(19,'TRe');
...
CREATE TABLE `references_keywords` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10764 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (10755,'Env',1),(10756,'Montagne',1),(10757,'Ecologie',1),(10758,'Méthodologie',1),(10759,'Références',1),(10760,'Ajout',1),(10761,'Suppression',1),(10762,'Documents',1),(10763,'Mots-clés',1);
...
INSERT INTO `serveur` VALUES (3,'Biot','\\\\192.168.73.1\\share\\biot','C:/wamp/www/Symfony/web/scriptsServeurs/Biot.bat'),(4,'Dijon','\\\\192.168.72.1\\share\\dijon','C:/wamp/www/Symfony/web/scriptsServeurs/Dijon.bat'),(5,'Ecuisses','\\\\192.168.71.1\\share\\ecuisses','C:/wamp/www/Symfony/web/scriptsServeurs/Ecuisses.bat'),(6,'Boulogne','\\\\192.168.68.1\\share\\boulogne','C:/wamp/www/Symfony/web/scriptsServeurs/Boulogne.bat'),(7,'Rennes','\\\\192.168.30.1\\share\\Rennes','C:/wamp/www/Symfony/web/scriptsServeurs/Rennes.bat'),(8,'Beaune','\\\\192.168.61.1\\share\\beaune','C:/wamp/www/Symfony/web/scriptsServeurs/Beaune.bat'),(9,'Aubière','\\\\192.168.63.1\\share\\Clermont','C:/wamp/www/Symfony/web/scriptsServeurs/Aubière.bat'),(10,'Angoulême','\\\\192.168.16.1\\share\\angouleme','C:/wamp/www/Symfony/web/scriptsServeurs/Angoulême.bat'),(11,'Brest','\\\\192.168.39.10\\share\\Brest','C:/wamp/www/Symfony/web/scriptsServeurs/Brest.bat'),(12,'Lorient','\\\\192.168.57.1\\share\\lorient','C:/wamp/www/Symfony/web/scriptsServeurs/Lorient.bat'),(13,'Paris','\\\\192.168.75.1\\share\\paris','C:/wamp/www/Symfony/web/scriptsServeurs/Paris.bat'),(14,'Saintes','\\\\192.168.17.1\\share\\saintes','C:/wamp/www/Symfony/web/scriptsServeurs/Saintes.bat'),(16,'Bron Energie','\\\\192.168.69.1\\ze','C:/wamp/www/Symfony/web/scriptsServeurs/Bron Energie.bat'),(17,'Woippy','\\\\192.168.67.1\\share\\woippy','C:/wamp/www/Symfony/web/scriptsServeurs/Woippy.bat');
...
CREATE TABLE `suivis` (
  ...
  `Marche` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `NoCommande` longtext COLLATE utf8_unicode_ci COMMENT '(DC2Type:array)',
  `NoClient` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Objet` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `NoINGEDIABEP` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Estimatif` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `NoInterlocuteur` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `suivis` VALUES (52,'Test Suivi','Rennes',8795,'Informatique','En cours',20,'Buffières','LeMarché','a:2:{i:0;s:3:\"111\";i:6;s:3:\"546\";}','22299','Masse de tune','56sq54d','1 Milliard de dollars',NULL),(53,'Achat Objets 2016','Bron',4856,'Informatique','En cours',20,'Buffières','LeMarché','a:1:{i:0;s:2:\"11\";}','13','Masse de tune','56sq54d','1 Milliard de dollars',15751),(54,'Suivi 2','Bron',879564,'Informatique','En cours',20,NULL,NULL,'N;',NULL,NULL,NULL,NULL,NULL),(55,'Suivi 4','Rennes',874556,'Informatique','En cours',20,NULL,NULL,'N;',NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2016-05-02  8:00:15
