...
INSERT INTO `compteur` VALUES (5,'Accueil','691');
...
INSERT INTO `donnees_suivi` VALUES (6,39,1,'a:1:{s:5:\"Objet\";a:3:{s:4:\"Data\";s:6:\"sqdsqd\";s:4:\"Type\";s:4:\"text\";s:8:\"Position\";s:2:\"A1\";}}','efdfs_v1');
...
INSERT INTO `message_alert` VALUES (1,'Accueil','<p style=\"text-align:center\"><span style=\"font-size:36px\">Ceci est un test de message d&#39;alerte.</span></p>\r\n\r\n<p style=\"text-align:center\"><img alt=\"\" src=\"/intranet/uploads/ImagesPublication/images.jpg\" style=\"height:225px; width:225px\" /></p>',1);
...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=94691 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (10719,'Env',1),(10720,'Montagne',1),(10721,'Ecologie',1),(10722,'Méthodologie',1),(10723,'Références',1),(10724,'Ajout',1),(10725,'Suppression',1),(10726,'Documents',1),(10727,'Mots-clés',1);
...
INSERT INTO `suivis` VALUES (38,'Achat Objets 2016','Bron',8795,'Informatique','En cours',20,'Lyon','Marché','a:2:{i:0;s:8:\"89746545\";s:11:\"noCommande2\";s:3:\"dsf\";}','8143','Objet','78543','10005'),(39,'efdfs','ddsf',564564,'Informatique','En cours',20,'gfhgfh','gfhgfhgf','a:2:{i:0;s:6:\"gfhgfh\";s:11:\"noCommande2\";s:4:\"fdgg\";}','2124','gfhgf','gfhgfh','56445');
...
-- Dump completed on 2016-04-18  8:00:02
