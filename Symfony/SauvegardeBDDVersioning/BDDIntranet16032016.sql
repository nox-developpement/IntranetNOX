...
INSERT INTO `compteur` VALUES (1,'Accueil','1935');
...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32944 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `references_keywords` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7398 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (7389,'Env',1),(7390,'Montagne',1),(7391,'Ecologie',1),(7392,'Méthodologie',1),(7393,'Références',1),(7394,'Ajout',1),(7395,'Suppression',1),(7396,'Documents',1),(7397,'Mots-clés',1);
...
-- Dump completed on 2016-03-16  8:00:05
