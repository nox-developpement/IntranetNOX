...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27552 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (6741,'Env',1),(6742,'Montagne',1),(6743,'Ecologie',1),(6744,'Méthodologie',1),(6745,'Références',1),(6746,'Ajout',1),(6747,'Suppression',1),(6748,'Documents',1),(6749,'Mots-clés',1);
...
-- Dump completed on 2016-03-13  8:00:04
