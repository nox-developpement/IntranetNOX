...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8112 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (2196,'Env',1),(2197,'Montagne',1),(2198,'Ecologie',1),(2199,'Méthodologie',1),(2200,'Références',1),(2201,'Ajout',1),(2202,'Suppression',1),(2203,'Documents',1),(2204,'Mots-clés',1);
...
-- Dump completed on 2016-02-21  8:00:15
