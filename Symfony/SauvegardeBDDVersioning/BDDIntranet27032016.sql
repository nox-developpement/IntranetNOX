...
INSERT INTO `compteur` VALUES (5,'Accueil','78');
...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53199 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `references_keywords` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9756 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (9747,'Env',1),(9748,'Montagne',1),(9749,'Ecologie',1),(9750,'Méthodologie',1),(9751,'Références',1),(9752,'Ajout',1),(9753,'Suppression',1),(9754,'Documents',1),(9755,'Mots-clés',1);
...
-- Dump completed on 2016-03-27  9:00:08
