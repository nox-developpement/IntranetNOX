...
<div id="loginBox">
    ...
    <form action="login.php" method="post">
        ...
        <fieldset>
        <input placeholder="Nom d'utilisateur" type="text" name="userid" id="name" value="<?php echo $info['userid']; ?>" autocorrect="off" autocapitalize="off">
        <input placeholder="Mot de passe" type="password" name="passwd" id="pass" autocorrect="off" autocapitalize="off">
