...
<div id="loginBox">
    ...
    <form action="login.php" method="post">
        ...
        <fieldset>
            <input type="text" name="userid" id="name" value="<?php echo $info['userid']; ?>" placeholder="Nom d'utilisateur" autocorrect="off" autocapitalize="off">
            <input type="password" name="passwd" id="pass" placeholder="Mot de passe" autocorrect="off" autocapitalize="off">
