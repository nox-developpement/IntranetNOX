...
<form action="login.php" method="post" id="clientLogin">
    ...
    <div style="display:table-row">
        <div class="login-box">
            ...
            <div>
                <input id="username" placeholder="Nom d'utilisateur" type="text" name="luser" size="30" value="<?php echo $email; ?>">
            </div>
            <div>
...
<?php } ?>
            <div>
                ...
                <a href="<?php echo '/Symfony/web/support/scp/index.php'; ?>"><?php echo __('sign in here'); ?></a>
            </div>
        </div>
    </div>
</form>
