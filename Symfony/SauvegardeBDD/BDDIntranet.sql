...
INSERT INTO `compteur` VALUES (1,'Accueil','1785');
...
INSERT INTO `formulaires` VALUES (49,'Quantité','Nombre','Informatique',NULL),(50,'Objet','Texte','Informatique',NULL),(51,'Type','Données','Informatique',NULL),(52,'TestSelect','Données','Informatique',NULL),(53,'TestChampSuivant','Texte','Informatique',NULL),(54,'Test champ','Données','Informatique',1),(55,'Test2','Texte','Informatique',0),(56,'ChampFalse','Données','Informatique',0),(57,'TEstdsqd','Texte','Informatique',0);
...
INSERT INTO `liaison_suivi_champ` VALUES (3,49,1,'E2'),(4,52,1,'D2');
...
CREATE TABLE `pdf` (
  ...
  `Lien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29016 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `references_keywords` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6966 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (6957,'Env',1),(6958,'Montagne',1),(6959,'Ecologie',1),(6960,'Méthodologie',1),(6961,'Références',1),(6962,'Ajout',1),(6963,'Suppression',1),(6964,'Documents',1),(6965,'Mots-clés',1);
...
-- Dump completed on 2016-03-14  8:00:02
