...
INSERT INTO `compteur` VALUES (1,'Accueil','1432');
...
CREATE TABLE `references_keywords` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4590 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `references_keywords` VALUES (4581,'Env',1),(4582,'Montagne',1),(4583,'Ecologie',1),(4584,'Méthodologie',1),(4585,'Références',1),(4586,'Ajout',1),(4587,'Suppression',1),(4588,'Documents',1),(4589,'Mots-clés',1);
...
-- Dump completed on 2016-03-03  8:00:03
